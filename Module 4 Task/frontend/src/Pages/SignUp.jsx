          ...
          <div className="mt-20 flex w-full flex-col items-start justify-start p-6 md:w-1/2 lg:px-10">
            ...
            >
              <div className="flex w-full flex-col items-start justify-start gap-2">
                <label id="fullname" className="text-xs text-slate-200">
                  Full name
                </label>
                <input
              ...
              <button
                type="submit"
                className="w-full mt-7 bg-[#ae7aff] p-3 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e]"
              >
                Create Account
              </button>
            </form>
