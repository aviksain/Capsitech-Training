...
function TodoItem({ todo }: { todo: any }) {
  ...
  const toggleCompleted = async () => {
    try {
      ...
      dispatch(toggleCompletedRedux(res?.todo._id));
    } catch (error) {}

    dispatch(toggleCompletedRedux(todo._id));
  };

  return (
    <>
      <DeletePopup showPopup={showPopup} setShowPopup={setShowPopup} todoId={todo._id}/>
